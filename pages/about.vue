<template>
  <div class="About">
    ...
    <TextCard>
      {{
        "当サイトは新型コロナウイルス感染症に関する最新情報を提供するために、大阪府が CodeForOSAKA の協力を得て開設したものです。"
      }}
      <br />
      <br />
      {{
    ...
    <TextCard :title="'データについて'">
      {{
        "本サイトで公表している元データは、大阪府ホームページ「新型コロナウイルス感染症について」で公表しています。"
      }}
    </TextCard>
    <TextCard :title="'ソースコードについて'">
      {{
        "本サイトのソースコードはMITライセンスで公開されており、誰でも自由に利用することができます。詳しくは、{githubRepo}をご確認ください。"
      }}
    </TextCard>
  </div>
</template>
